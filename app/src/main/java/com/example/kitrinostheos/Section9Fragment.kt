...
class Section9Fragment : Fragment(), WebViewReloadable {
    ...
    override fun onCreateView(
        ...
        // DNS Prefetching
        webView.loadUrl("javascript:(function() { var link = document.createElement('link'); link.rel = 'dns-prefetch'; link.href = 'totalracing.gr'; document.head.appendChild(link); })();")

        // Load the initial URL
        webView.loadUrl("https://totalracing.gr/category/f1/")
        return rootView
    }
